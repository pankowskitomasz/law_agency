...
<head>
    ...
    <meta property="og:title" content="Law Firm">
    ...
    <title>Law Firm | Message sent</title>
</head>
<body class="bg-secondary">
                ...
                <div class="col-xs-12 col-sm-8 col-md-6 offset-sm-2 offset-md-3 text-center">
                    <div class="card shadow">
                        <div class="card-header">                            
                            <h4 class="text-center initialism text-secondary mb-0">
                                Message sent!
                            </h4>
                        </div>
                        <div class="card-body">
    ...
    <section class="contact-s2 align-items-center d-flex container text-shadow bg-secondary minh-30vh py-5 border-top border-primary">
